...
const ECSParser = (function() {
    ...
    /**
     * Parse multiple events from various input formats
     */
    ...
    /**
     * Build host registry from parsed events
     * Maps IPs and hostnames to canonical host entries
     */
    function buildHostRegistry(events) {
    ...
    /**
     * Identify cross-host connections for drawing lines
     */
    function identifyConnections(events, hostRegistry) {
        const connections = [];
    ...
    return {
        parse: parseEvents,
        buildHostRegistry: buildHostRegistry,
        identifyConnections: identifyConnections,
