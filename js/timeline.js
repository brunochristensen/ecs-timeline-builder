...
const TimelineVis = (function() {
     ...
     */
    function init(containerId, eventClickHandler) {
    ...
    /**
     * Render the timeline with parsed events
     */
    function render(events, hostRegistry, connections) {
